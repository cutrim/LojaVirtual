...
public class FormaPagamentoConverter implements Converter{
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String valor) {
		...
		if (valor != null && !valor.isEmpty()) {
            return (FormaPagamento) arg1.getAttributes().get(valor);
        }
        return null;
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object arg2) {
		// TODO Auto-generated method stub
		if (arg2 instanceof FormaPagamento) {
			FormaPagamento entity= (FormaPagamento) arg2;
            if (entity != null && entity instanceof FormaPagamento && entity.getId() != null) {
